...
M7 source builds default to SDK 1.2.0; the gate wire protocol remains 1.1. The opt-in C++ QEMU runner lives separately in [qemu-runners/cpp-runner/](../qemu-runners/cpp-runner/README.md), with its explicit device/network boundary described in [M7 backends](../docs/m7-backends.md).
