...
app_source=/tmp/graphlab-logs-20260923
...
"$app_cmake" --build "$app_source/build/dev" --target lab-agent lab-api lab-terminal lab-capture m2_tests m4_linux process_log_tests process_log_linux -j 4
"$app_source/build/dev/process_log_tests"
